...
# I am storing both the training and prediction datasets in my github repository 
...
files = [Grigorieva_Darja, Khomich_Michelle, Nitzsche_Lavinia_Maria,Ribbert_Paula, Wächter_Daria]
